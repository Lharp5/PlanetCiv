...
public int quakeDamage(){
  ...
  public void displayMenu(){
    if(populated){
      ...
      stroke(0);
      fill(230);
      rect((width / 2) + 280, 175, 90, 30); //city
      rect((width / 2) + 280, 210, 90, 30); // defense
      rect((width / 2) + 280, 245, 90, 30); //research
      rect((width / 2) + 280, (height / 2) + 65, 90, 30); //ship 1
      rect((width / 2) + 280, (height / 2) + 100, 90, 30); //ship 2
